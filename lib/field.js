  ...
  Field = (function() {
    ...
    */
    ...
    Field.prototype.init = function() {
      ...
      this._addAllFields(this, this.allFields = []);
    ...
    */
    ...
    Field.prototype._addAllFields = function(start, allFields) {
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        field = _ref[_i];
        _results.push(field._addAllFields(start, allFields));
      }
      return _results;
    };
    ...
    */
    ...
    Field.prototype.canFetch = function(model) {
      return this.fetcher.canFetch(model);
    };
