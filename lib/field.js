...
(function() {
  ...
  Field = (function() {
    ...
    */
    ...
    Field.prototype.field = function(property, closest) {
      ...
      if (field && path.length) {
        return (_ref = field.field(path.join("."), closest)) != null ? _ref : closest ? field : void 0;
      } else {
        return field;
      }
    };
    ...
    */
    ...
    Field.prototype.fields = function(fieldNames, closest) {
      ...
      for (_i = 0, _len = fieldNames.length; _i < _len; _i++) {
        ...
        field = this.field(property, closest);
