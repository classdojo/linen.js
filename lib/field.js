...
(function() {
  var Field, Model, Validator, async, bindable, dref, getFetcher, getMapper, outcome, payload, type, _;
  ...
  Field = (function() {
    ...
    */
    ...
    Field.prototype.field = function(property, closest) {
      var field, path, _ref;
    ...
    */
    ...
    Field.prototype.load = function(model, next) {
      ...
      return model._memoizer.call(this.path, (_ref = this.options.memoize) != null ? _ref : {
        maxAge: 1000 * 5
      }, next, function(next) {
        return _this.fetch(payload.model(model).method("get").options, next);
      });
    };
