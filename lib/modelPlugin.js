  ...
  ModelPlugin = (function() {
    ...
    */
    ...
    ModelPlugin.prototype.createCollection = function(path, options) {
      var collection, isStatic, isVirtual, modelClass, oldBind, oldReset, self, _ref, _ref1, _ref2,
        _this = this;
      ...
      self = this;
      isVirtual = options.definition ? (_ref = options.definition) != null ? (_ref1 = _ref.options) != null ? _ref1.$isVirtual : void 0 : void 0 : true;
      isStatic = (_ref2 = options.definition) != null ? _ref2.$isStatic : void 0;
      ...
      collection.transform().cast(modelClass).map(function(itemOrId) {
        var item;
      ...
      collection.item = function(data) {
        var isNew, model, p, _ref3;
        ...
        isNew = !data._id;
        console.log(options);
        data._id = data._id || Math.random() + "_" + Date.now();
        model = new modelClass(data);
        model._isNew = isNew;
        p = null;
        model.requestOptions = {
          path: ((_ref3 = options.definition) != null ? _ref3.key : void 0) || path
        };
        return model;
      };
      ...
      collection._fetchVirtual = function(callback) {
        ...
        return self._fetch({
          method: "GET",
          item: this
        }, outcome.e(callback).s(function(source) {
          _this.reset(source);
          return callback();
        }));
      };
    ...
    */
    ...
    ModelPlugin.prototype._setup = function() {
      ...
      modelBuilder.methods._fetch = cstep(function(next) {
        ...
        this.requestOptions[name] = this.isNew() ? void 0 : this.get("_id");
