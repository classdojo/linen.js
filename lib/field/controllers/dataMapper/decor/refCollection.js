...
(function() {
  var CollectionMapper, ReferenceMapper, bindable, hoist, toarray,
  ...
  CollectionMapper = (function(_super) {
    ...
    */
    ...
    CollectionMapper.prototype.map = function(model, source) {
      ...
      c.transform().map(function(v) {
        return _this._refMapper.map(model, v);
      });
    ...
    */
    ...
    CollectionMapper.prototype.normalize = function(model) {
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        item = _ref[_i];
        source.push(this._refMapper.normalize(model));
      }
      return source;
    };
