...
(function() {
  var MemoDictionary, Transporter, async, dataMapper, payload, transporterFactory, type, validator,
  ...
  Transporter = (function(_super) {
    ...
    */
    ...
    Transporter.prototype.prepareModel = function(model, data) {
      ...
      return model.on("watching", function(property) {
        ...
        return (_ref = _this.rootField.getField(property, true)) != null ? _ref._transporter.request(payload.model(model).method("get").options, function() {}) : void 0;
      });
    };
    ...
    */
    ...
    Transporter.prototype.load = function(model, next) {
      return this._request(payload.model(model).method("get"), next);
    };
    ...
    */
    ...
    Transporter.prototype._request = function(payload, next) {
      return async.forEach(this._decorators, (function(decor, next) {
        return decor.request(payload.options, next);
      }), next);
    };
