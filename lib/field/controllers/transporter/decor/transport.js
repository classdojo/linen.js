  ...
  Transport = (function(_super) {
    ...
    */
    ...
    Transport.prototype.request = function(options, next) {
      var currentHash, method, model, payload,
        _this = this;
      ...
      return options.model._memos.call(currentHash = this._payloadHash(options), this._memoOps, next, function(next) {
        ...
        return method(payload, function(err, result) {
          ...
          return setTimeout((function() {
            ...
            options.model.reset(JSON.parse(JSON.stringify(result)), _this.field.path);
            newData = {};
            for (newKey in result) {
              newData[newKey] = model.get(newKey);
            }
            model._cache.store(_this._getPayloadData(payload));
