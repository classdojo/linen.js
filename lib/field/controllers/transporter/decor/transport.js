  ...
  Transport = (function(_super) {
    ...
    */
    ...
    Transport.prototype._getPayloadData = function(payload, pluck) {
      var d, dataFields, field, fieldData, model, newData, _i, _len;
      ...
      d = {};
      fieldData = this.field._mapper.normalize(model, model.get(this.field.path));
      if (this.field.parent) {
        dref.set(d, this.field.path, fieldData);
      } else {
        d = fieldData;
      }
