  ...
  module.exports = Route = (function() {
    ...
    */
    function Route(options, parent, name) {
      ...
      _ref = ["routeRequestOptions", "routeResponse", "routeCollection", "routeItem", "routeItemPath", "routeCollectionPath"];
    ...
    */
    ...
    Route.prototype.path = function(options) {
      ...
      if (item) {
        pathParts.push(this._option("routeItemPath").call(this, item));
      } else {
        pathParts.push(this._option("routeCollectionPath").call(this, item));
      }
  ...
  module.exports = (function(_super) {
    ...
    */
    ...
    function _Class(options) {
      ...
      this._defaultRouteResponse = __bind(this._defaultRouteResponse, this);      _.defaults(options, {
        routeRequestOptions: this._defaultRouteRequestOptions,
        routeResponse: this._defaultRouteResponse,
        routeCollection: this._defaultRouteCollection,
        routeItem: this._defaultRouteItem,
        routeItemPath: this._routeDefaultItemPath,
        routeCollectionPath: this._routeDefaultCollectionPath
      });
    ...
    */
    ...
    _Class.prototype._routeDefaultItemPath = function(item) {
    ...
    */
    ...
    _Class.prototype._routeDefaultCollectionPath = function() {
      return this._path;
    };
