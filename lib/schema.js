...
(function() {
  var ChangeWatcher, Field, MemoDictionary, Model, Schema, payload, type, _ref,
  ...
  Schema = (function(_super) {
    ...
    */
    ...
    Schema.prototype.save = function(model, next) {
      ...
      if (model.isNew()) {
        p.method("post").body(this._getModelData(model.data, this.fields(model._changeWatcher.flushChangesKeys(), true)));
      } else {
        p.method("put").body(this._getModelData(model.data));
      }
    ...
    */
    ...
    Schema.prototype.toObject = function(model) {
      return this._getModelData(model.data);
    };
    ...
    */
    ...
    Schema.prototype._getModelData = function(data, fields) {
      if (fields == null) {
