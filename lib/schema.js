  ...
  Schema = (function(_super) {
    ...
    */
    ...
    Schema.prototype.save = function(model, next) {
      ...
      if (model.isNew()) {
        p.method("post").body(this.toJSON(model, model.data));
      } else {
        p.method("put").body(this.toJSON(model, model.data, {
          fields: this._getChangedFields(model)
        }));
      }
    ...
    */
    ...
    Schema.prototype._getChangedFields = function(model) {
      var changedFields, field, _i, _len, _ref1;

      changedFields = [];
      _ref1 = this.allFields;
