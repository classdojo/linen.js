  ...
  Collection = (function(_super) {
    ...
    */
    ...
    Collection.prototype._persistInsert = function(model) {
      ...
      return this.field.fetch(payload.collection(this).target(model).method("POST").data, next);
    };
    ...
    */
    ...
    Collection.prototype._persistRemove = function(model) {
      ...
      return this.field.fetch(payload.collection(this).target(model).method("DELETE").data, next);
    };
